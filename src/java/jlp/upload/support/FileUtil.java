...
public class FileUtil {
     ...
     * 当前目录路径
     */
    public static String currentWorkDir = "E://";
    ...
    public static ArrayList<File> getDirFiles(String dirPath,
        ...
        File[] fileArr = path.listFiles(new FilenameFilter() {
            public boolean accept(File dir, String name) {
                ...
                String lowerPrefix = preffix.toLowerCase();
    ...
    public ArrayList<File> sort(ArrayList<File> partFiles){
	   ArrayList<File> copy=new ArrayList<File>();
	   int arr[]=new int[partFiles.size()];
	   for(File f:partFiles){
		   arr[getNum(f.getName())]=partFiles.indexOf(f);
	   }
	   for(int i:arr){
		   copy.add(partFiles.get(i));
	   }
	   return copy;
    };
    ...
    public  int getNum(String name){
    	String s[]=name.split("\\[|\\]");
    	int size=s.length;
    	return Integer.parseInt(s[size-2]);
    }
    ...
    private class MergeRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
            	...
            	FileUtil.delete(partFile.getPath());
            }
        }
    }
